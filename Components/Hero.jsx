          ...
          <div className="flex flex-col items-center justify-center xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h3 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                Crypto Predictor: <br className="hidden md:block" />
                Predict the price of different crypto currencies
              </h3>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Reiciendis magnam pariatur beatae, nisi neque sequi cumque obcaecati magni minus a, amet enim in repellat odit. Quibusdam ut consequatur omnis facere.
              </p>
              <a
                href="/"
                aria-label=""
              ...
              >
                ...
                <svg
                  className="inline-block w-3 ml-2 mt-[6px]"
                  fill="currentColor"
                  viewBox="0 0 12 12"
                >
