    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center p-8">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-3xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold mb-14 -mt-1 text-center text-white">Verify Your World ID</h1>
          
          <div className="relative mt-8 mb-8 p-6 border-2 border-blue-200 rounded-lg bg-white shadow-lg transform hover:scale-105 transition-transform duration-300">
            <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 w-24 h-24 bg-white rounded-full border-4 border-blue-500 flex items-center justify-center overflow-hidden">
              <img 
          ...
          {account.isConnected && (
            <div className="space-y-4">
              ...
              {isConfirming && <p className="text-yellow-600 text-center">Waiting for confirmation...</p>} 
              {isConfirmed && <p className="text-green-600 text-center font-semibold">Transaction confirmed!</p>}
              {error && (
